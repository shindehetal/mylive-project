...
const Basic = () => {
    ...
    let [profilestatus, setProfile] = useState(basicdata.profilestatus);
                            ...
                            <div className="form-group row">
                                ...
                                <div className="mb-4 col-xl-6">
                                    ...
                                    <select className="form-select"
                                        onChange={obj => setGender(obj.target.value)} value={gender}>
                                ...
                                <div className="mb-4 col-xl-6">
                                    ...
                                    <select className="form-select" onChange={obj => setProfile(obj.target.value)} value={profilestatus}>
                                        <option>Select</option>
